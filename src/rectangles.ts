...
export class Rectangle implements
    ...
    public set(rect: Partial<Readonly<RectangleLiteral>>) {
    ...
    public add(rect: Partial<Readonly<RectangleLiteral>>) {
        if (typeof rect.x !== 'undefined') {
            this.x += rect.x;
        }
    ...
    public subtract(rect: Partial<Readonly<RectangleLiteral>>) {
        if (typeof rect.x !== 'undefined') {
            this.x -= rect.x;
        }
    ...
    public multiply(rect: Partial<Readonly<RectangleLiteral>>) {
        if (typeof rect.x !== 'undefined') {
            this.x *= rect.x;
        }
    ...
    public divide(rect: Partial<Readonly<RectangleLiteral>>) {
        if (typeof rect.x !== 'undefined') {
            this.x /= rect.x;
        }
    ...
    public expand(vec2: Readonly<Vector2Literal>) {
        if (vec2.x < this.left) {
            this.left = vec2.x;
        }
    ...
    public toLiteral() {
        return { x: this.x, y: this.y, width: this.width, height: this.height } as const;
    }
    ...
    public static fromLiteral(literal: Readonly<RectangleLiteral>) {
